...
Six integration adapters are shipped and harness-verified — PNTMAP
...
Picogrid Legion Platform API v3, and ASTERIX category 021 ADS-B target
reports (bidirectional) — with more landing next: STANAG 4676 tracks,
the other ASTERIX categories (062 system tracks, 023 service status),
