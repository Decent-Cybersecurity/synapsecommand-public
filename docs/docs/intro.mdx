...
Seven integration adapters are shipped and harness-verified — PNTMAP
...
reports (bidirectional), and STANAG 4676 / AEDP-12 Edition B NITS tracks
(bidirectional) — with more landing next: the other ASTERIX categories
(062 system tracks, 023 service status) and simulation feeds.
