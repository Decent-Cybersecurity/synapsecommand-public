...
Three integration adapters are shipped and harness-verified — PNTMAP
GNSS alerts, TAK / Cursor-on-Target (bidirectional) and AIS / NMEA 0183
AIVDM (bidirectional) — with more landing next: ADS-B, STANAG 4676
tracks, ASTERIX radar, Picogrid Legion, and simulation feeds.
