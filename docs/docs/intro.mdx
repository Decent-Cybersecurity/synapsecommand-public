...
Four integration adapters are shipped and harness-verified — PNTMAP
GNSS alerts, TAK / Cursor-on-Target (bidirectional), AIS / NMEA 0183
AIVDM (bidirectional) and ADS-B 1090ES extended squitter
(bidirectional) — with more landing next: STANAG 4676 tracks, ASTERIX
radar, Picogrid Legion, and simulation feeds.
