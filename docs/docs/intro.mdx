...
Two integration adapters are shipped and harness-verified — PNTMAP GNSS
alerts and TAK / Cursor-on-Target (bidirectional) — with more landing
next: AIS, ADS-B, STANAG 4676 tracks, ASTERIX radar, Picogrid Legion,
