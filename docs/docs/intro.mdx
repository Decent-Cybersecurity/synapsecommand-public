...
Thirteen integration adapters are shipped and harness-verified — PNTMAP
...
translations and N private notions of what "a contact" is — seventy-eight
and thirteen as of today — and the integration layer becomes the place
...
Everything it needs comes with it. The twelve shipped adapters' **fixtures are part of the package**,
so the harness runs against the payloads those adapters are verified on without a repository
anywhere:
