...
Five integration adapters are shipped and harness-verified — PNTMAP
...
and Picogrid Legion Platform API v3 — with more landing next: STANAG
4676 tracks, ASTERIX radar, and simulation feeds.
