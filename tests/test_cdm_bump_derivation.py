...
UNRULED_HISTORICAL_ARCS = {
    ...
    # The tenth row, written IN the 3.0.0 release commit (2026-09-20) from the gate's own
    # `derive(snapshot_at("v2.2.0"), snapshot_at(None))` on that tree, so that the tag needs no
    # re-tag for it. The 145 are the audit remediation arc's (F01–F09, S10) plus the two the
    # release commit itself moved into the set: `manifest.py:ClaimStatus` (ruling B) and the
    # eleven adapter classes' metadata (ruling A, inside units S10 had already ruled). Every one
    # is ruled in MIGRATIONS.md's `### 3.0.0` section.
    ("v2.2.0", "v3.0.0"): {
        "pyproject.toml:optional-dependencies",
        "synapse_cdm/adapter.py:Adapter",
        "synapse_cdm/adapters/adsb.py:<statement 9>",
        "synapse_cdm/adapters/adsb.py:AdsbAdapter",
        "synapse_cdm/adapters/ais.py:<statement 9>",
        "synapse_cdm/adapters/ais.py:AisAdapter",
        "synapse_cdm/adapters/asterix_cat021.py:<statement 8>",
        "synapse_cdm/adapters/asterix_cat021.py:AsterixCat021Adapter",
        "synapse_cdm/adapters/asterix_cat023.py:<statement 8>",
        "synapse_cdm/adapters/asterix_cat023.py:AsterixCat023Adapter",
        "synapse_cdm/adapters/asterix_cat034.py:<statement 8>",
        "synapse_cdm/adapters/asterix_cat034.py:AsterixCat034Adapter",
        "synapse_cdm/adapters/asterix_cat048.py:<statement 8>",
        "synapse_cdm/adapters/asterix_cat048.py:AsterixCat048Adapter",
        "synapse_cdm/adapters/asterix_cat062.py:<statement 9>",
        "synapse_cdm/adapters/asterix_cat062.py:AsterixCat062Adapter",
        "synapse_cdm/adapters/gmtif.py:<statement 9>",
        "synapse_cdm/adapters/gmtif.py:GmtifAdapter",
        "synapse_cdm/adapters/legion.py:<statement 10>",
        "synapse_cdm/adapters/legion.py:LegionAdapter",
        "synapse_cdm/adapters/pntmap.py:<statement 10>",
        "synapse_cdm/adapters/pntmap.py:PntmapAdapter",
        "synapse_cdm/adapters/stanag4586.py:<statement 9>",
        "synapse_cdm/adapters/stanag4586.py:Stanag4586Adapter",
        "synapse_cdm/adapters/stanag4609.py:<statement 17>",
        "synapse_cdm/adapters/stanag4609.py:Stanag4609Adapter",
        "synapse_cdm/adapters/stanag4676.py:<statement 10>",
        "synapse_cdm/adapters/stanag4676.py:<statement 11>",
        "synapse_cdm/adapters/stanag4676.py:<statement 12>",
        "synapse_cdm/adapters/stanag4676.py:<statement 1>",
        "synapse_cdm/adapters/stanag4676.py:<statement 2>",
        "synapse_cdm/adapters/stanag4676.py:<statement 3>",
        "synapse_cdm/adapters/stanag4676.py:<statement 4>",
        "synapse_cdm/adapters/stanag4676.py:<statement 5>",
        "synapse_cdm/adapters/stanag4676.py:<statement 6>",
        "synapse_cdm/adapters/stanag4676.py:<statement 7>",
        "synapse_cdm/adapters/stanag4676.py:<statement 8>",
        "synapse_cdm/adapters/stanag4676.py:<statement 9>",
        "synapse_cdm/adapters/stanag4676.py:Stanag4676Adapter",
        "synapse_cdm/adapters/stanag4676.py:_serialise",
        "synapse_cdm/adapters/stanag4676.py:parse_document",
        "synapse_cdm/adapters/tak.py:<statement 9>",
        "synapse_cdm/adapters/tak.py:TakAdapter",
        "synapse_cdm/conformance.py:<statement 12>",
        "synapse_cdm/conformance.py:<statement 13>",
        "synapse_cdm/conformance.py:<statement 14>",
        "synapse_cdm/conformance.py:<statement 4>",
        "synapse_cdm/conformance.py:<statement 5>",
        "synapse_cdm/conformance.py:<statement 6>",
        "synapse_cdm/conformance.py:<statement 7>",
        "synapse_cdm/conformance.py:_validator",
        "synapse_cdm/conformance.py:assess",
        "synapse_cdm/conformance.py:assess_a",
        "synapse_cdm/evidence.py:<statement 10>",
        "synapse_cdm/evidence.py:<statement 11>",
        "synapse_cdm/evidence.py:<statement 12>",
        "synapse_cdm/evidence.py:<statement 13>",
        "synapse_cdm/evidence.py:<statement 14>",
        "synapse_cdm/evidence.py:<statement 15>",
        "synapse_cdm/evidence.py:<statement 16>",
        "synapse_cdm/evidence.py:<statement 17>",
        "synapse_cdm/evidence.py:<statement 18>",
        "synapse_cdm/evidence.py:<statement 4>",
        "synapse_cdm/evidence.py:<statement 5>",
        "synapse_cdm/evidence.py:<statement 6>",
        "synapse_cdm/evidence.py:<statement 7>",
        "synapse_cdm/evidence.py:<statement 8>",
        "synapse_cdm/evidence.py:<statement 9>",
        "synapse_cdm/evidence.py:EvidenceRecord",
        "synapse_cdm/evidence.py:badges",
        "synapse_cdm/evidence.py:build_parser",
        "synapse_cdm/evidence.py:generate",
        "synapse_cdm/evidence.py:main",
        "synapse_cdm/evidence.py:reproduce",
        "synapse_cdm/evidence.py:source_commit",
        "synapse_cdm/geo.py:MultiLineString",
        "synapse_cdm/geo.py:MultiPolygon",
        "synapse_cdm/geo.py:Polygon",
        "synapse_cdm/geo.py:_check_lonlat",
        "synapse_cdm/harness.py:<statement 10>",
        "synapse_cdm/harness.py:<statement 8>",
        "synapse_cdm/harness.py:<statement 9>",
        "synapse_cdm/harness.py:_check_roundtrip",
        "synapse_cdm/harness.py:_compare_emitted",
        "synapse_cdm/harness.py:load_raw",
        "synapse_cdm/harness.py:main",
        "synapse_cdm/harness.py:render_report",
        "synapse_cdm/harness.py:render_roster",
        "synapse_cdm/harness.py:run",
        "synapse_cdm/lossless.py:<statement 1>",
        "synapse_cdm/lossless.py:<statement 2>",
        "synapse_cdm/lossless.py:<statement 3>",
        "synapse_cdm/manifest.py:AdapterMetadata",
        "synapse_cdm/manifest.py:ClaimStatus",
        "synapse_cdm/models.py:<statement 4>",
        "synapse_cdm/models.py:<statement 8>",
        "synapse_cdm/models.py:CDMBase",
        "synapse_cdm/models.py:Entity",
        "synapse_cdm/models.py:Event",
        "synapse_cdm/models.py:Period",
        "synapse_cdm/models.py:PlanObject",
        "synapse_cdm/models.py:Position",
        "synapse_cdm/models.py:Route",
        "synapse_cdm/models.py:RouteLeg",
        "synapse_cdm/models.py:SourceRef",
        "synapse_cdm/models.py:TemporalValidity",
        "synapse_cdm/models.py:Timestamp",
        "synapse_cdm/models.py:Track",
        "synapse_cdm/schemas.py:<statement 3>",
        "synapse_cdm/schemas.py:<statement 4>",
        "synapse_cdm/schemas.py:<statement 5>",
        "synapse_cdm/schemas.py:<statement 6>",
        "synapse_cdm/schemas.py:<statement 7>",
        "synapse_cdm/schemas.py:<statement 8>",
        "synapse_cdm/schemas.py:_schema",
        "synapse_cdm/schemas.py:evidence_schema",
        "synapse_cdm/schemas.py:generate",
        "synapse_cdm/schemas.py:manifest_schema",
        "synapse_cdm/suite.py:<statement 10>",
        "synapse_cdm/suite.py:<statement 11>",
        "synapse_cdm/suite.py:<statement 12>",
        "synapse_cdm/suite.py:<statement 13>",
        "synapse_cdm/suite.py:<statement 14>",
        "synapse_cdm/suite.py:<statement 15>",
        "synapse_cdm/suite.py:<statement 16>",
        "synapse_cdm/suite.py:<statement 6>",
        "synapse_cdm/suite.py:<statement 7>",
        "synapse_cdm/suite.py:<statement 8>",
        "synapse_cdm/suite.py:<statement 9>",
        "synapse_cdm/suite.py:_sweep",
        "synapse_cdm/suite.py:build_parser",
        "synapse_cdm/suite.py:check_malformed",
        "synapse_cdm/suite.py:check_parser_robustness",
        "synapse_cdm/suite.py:check_streaming",
        "synapse_cdm/suite.py:check_version",
        "synapse_cdm/suite.py:loss_report",
        "synapse_cdm/suite.py:main",
        "synapse_cdm/suite.py:render_report",
        "synapse_cdm/suite.py:run",
        "synapse_cdm/version.py:<statement 0>",
        "synapse_cdm/version.py:ADAPTER_API_VERSION",
        "synapse_cdm/version.py:EVIDENCE_SCHEMA_VERSION",
