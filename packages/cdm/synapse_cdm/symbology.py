...
speak are wider. This module holds the mappings in ONE place so that nineteen adapters cannot
grow nineteen slightly different opinions about what CoT's `a-s-` prefix means.
