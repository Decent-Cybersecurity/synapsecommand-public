...
speak are wider. This module holds the mappings in ONE place so that fourteen adapters cannot
grow fourteen slightly different opinions about what CoT's `a-s-` prefix means.
