...
speak are wider. This module holds the mappings in ONE place so that eight adapters cannot
grow eight slightly different opinions about what CoT's `a-s-` prefix means.
