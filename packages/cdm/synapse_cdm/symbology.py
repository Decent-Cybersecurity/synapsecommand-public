...
speak are wider. This module holds the mappings in ONE place so that nine adapters cannot
grow nine slightly different opinions about what CoT's `a-s-` prefix means.
