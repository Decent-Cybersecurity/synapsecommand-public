...
speak are wider. This module holds the mappings in ONE place so that thirteen adapters cannot
grow thirteen slightly different opinions about what CoT's `a-s-` prefix means.
