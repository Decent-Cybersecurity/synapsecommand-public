...
speak are wider. This module holds the mappings in ONE place so that five adapters cannot
grow five slightly different opinions about what CoT's `a-s-` prefix means.
