...
notice", and that is not what this is: thirteen adapters are shipped and harness-verified, the
``Adapter`` contract has been stable across all thirteen of them, and the whole point of a
