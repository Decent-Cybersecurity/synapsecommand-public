    ...
    metadata = AdapterMetadata(
        ...
        maturity=Maturity(
            ...
            basis="L3 PROVENANCE VERIFIED, from evidence that runs today. The harness's "
                  ...
                  "conformance run --adapter cat062` computes E = PASS and `maturity_eligible` "
                ...
                declared_because={
                    "max_input_bytes": LimitBasis(
                        ...
                        source=(
                            ...
                            "a TWO-OCTET field and §4.6 makes it the total length of the whole "
                            "block including CAT and LEN — quoted at "
                            "`adapters/asterix_cat062.py`'s `parse_block`, where it is read as "
