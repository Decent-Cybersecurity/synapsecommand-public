    ...
    metadata = AdapterMetadata(
        ...
        maturity=Maturity(
            ...
            basis="L3 PROVENANCE VERIFIED, from evidence that runs today. The harness's "
                  ...
                  "conformance run --adapter cat034` computes E = PASS and `maturity_eligible` "
                  ...
                  "tests/test_cdm_asterix_cat034_adapter.py::test_every_fixture_round_trips_byte_for_byte. "
                ...
                declared_because={
                    "max_input_bytes": LimitBasis(
                        ...
                        source=(
                            ...
                            "`adapters/asterix_cat034.py`'s `parse_block`, where it is read as "
        ...
        limitations=[
            ...
            "`fixtures/cat034/spec/cat034_pin.json` records Edition 1.30 as available, and "
            "this adapter is written against 1.29",
