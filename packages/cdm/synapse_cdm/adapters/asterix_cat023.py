    ...
    metadata = AdapterMetadata(
        ...
        maturity=Maturity(
            ...
            basis="L3 PROVENANCE VERIFIED, from evidence that runs today. The harness's "
                  ...
                  "conformance run --adapter cat023` computes E = PASS and `maturity_eligible` "
        ...
        capabilities=Capabilities(
            ...
            message_types=[
                "ASTERIX data blocks of category 023 — the nine data items Edition 1.3 "
                "defines",
            ],
            limits=Limits(
                ...
                declared_because={
                    "max_input_bytes": LimitBasis(
                        ...
                        source=(
                            ...
                            "`adapters/asterix_cat023.py`'s `parse_block`, where it is read as "
        ...
        limitations=[
            ...
            "nothing outside them is decoded",
