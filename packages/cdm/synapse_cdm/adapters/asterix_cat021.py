    ...
    metadata = AdapterMetadata(
        ...
        maturity=Maturity(
            ...
            basis="L3 PROVENANCE VERIFIED, from evidence that runs today. The harness's "
                  ...
                  "conformance run --adapter cat021` computes E = PASS and `maturity_eligible` "
                  ...
                  "tests/test_cdm_asterix_cat021_adapter.py::test_ingest_then_egress_reproduces_the_block_octet_for_octet. "
                ...
                declared_because={
                    "max_input_bytes": LimitBasis(
                        ...
                        source=(
                            ...
                            "`adapters/asterix_cat021.py`'s `_parse_block`, where it is read as "
                            "`_u(data[1:3])`. Two octets cannot express more than "
        ...
        limitations=[
            ...
            "partially, and mostly in the Reserved Expansion Field",
            "Edition 2.6 states on its own cover that it is not backwards compatible to "
            "Edition 2.1 or earlier, and this adapter does not read those editions",
