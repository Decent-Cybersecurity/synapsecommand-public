    ...
    metadata = AdapterMetadata(
        ...
        maturity=Maturity(
            ...
            basis="L3 PROVENANCE VERIFIED, from evidence that runs today. The harness's "
                  ...
                  "conformance run --adapter stanag4609` computes E = PASS and `maturity_eligible` "
            ...
            limits=Limits(
                ...
                declared_because={
                    "max_input_bytes": LimitBasis(
                        ...
                        source=(
                            "A UAS Datalink Local Set packet's length is BER-encoded, and BER "
                            "long form can state a length no buffer could hold — "
                            "`adapters/klv_codec.py`'s own header sets out the rule and "
                            "records that not one example in 218 pages of the held documents "
                            "exercises long form at all. There is no normative figure to take. "
                            "1 MiB is chosen from the parser audit: the largest STANAG 4609 "
                            "fixture in this package is 15384 octets. This is an "
