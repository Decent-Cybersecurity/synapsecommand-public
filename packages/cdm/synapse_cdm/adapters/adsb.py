    ...
    metadata = AdapterMetadata(
        ...
        maturity=Maturity(
            ...
            basis="L3 PROVENANCE VERIFIED, from evidence that runs today. The harness's "
                  ...
                  "conformance run --adapter adsb` computes E = PASS and `maturity_eligible` reads "
                  ...
                  "tests/test_cdm_adsb_adapter.py::test_the_ingest_round_trip_is_byte_exact. L5 is "
                ...
                declared_because={
                    ...
                    "max_input_bytes": LimitBasis(
                        ...
                        source=(
                            ...
                            "(`text = line.strip()` in `adapters/adsb.py`'s `_parse_frame_line`), "
                            "so a bound of exactly 42 would refuse a "
