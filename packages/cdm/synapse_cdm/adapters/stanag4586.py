            ...
            limits=Limits(
                ...
                declared_because={
                    "max_input_bytes": LimitBasis(
                        ...
                        source=(
                            "§3.3.1.6 bounds ONE DLI message at 1..528 octets and the wrapper "
                            "at 16 (`adapters/stanag4586_codec.py:68`, `:82`-`:83`), but no "
                            "document in this tree bounds the number of messages one datagram "
                            "may carry, and this adapter accepts a datagram of several. 65536 "
                            "is chosen from the parser audit: it admits about 119 "
                            "maximum-length frames, and the largest STANAG 4586 fixture in "
                            "this package is 1725 octets. This is an IMPLEMENTATION CAP under "
