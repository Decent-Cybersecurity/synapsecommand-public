...
**There are THIRTY-TWO, and for six rounds there were none.** **There were TEN from the
...
the **park 5 round** of the same day, which added the nine payloads at the end of the table below
for the fifteen document-witnessed items.
